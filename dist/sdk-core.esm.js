...
var ERCToken = /*#__PURE__*/function (_BaseCurrency) {
  _inheritsLoose(ERCToken, _BaseCurrency);

  function ERCToken(chainId, address, decimals, symbol, name) {
    var _this;
...
var WETH9 = (_WETH = {}, _WETH[1] = /*#__PURE__*/new ERCToken(1, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WETH', 'Wrapped Ether'), _WETH[3] = /*#__PURE__*/new ERCToken(3, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether'), _WETH[4] = /*#__PURE__*/new ERCToken(4, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether'), _WETH[5] = /*#__PURE__*/new ERCToken(5, '0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6', 18, 'WETH', 'Wrapped Ether'), _WETH[42] = /*#__PURE__*/new ERCToken(42, '0xd0A1E359811322d97991E03f863a0C30C2cF029C', 18, 'WETH', 'Wrapped Ether'), _WETH[10] = /*#__PURE__*/new ERCToken(10, '0x4200000000000000000000000000000000000006', 18, 'WETH', 'Wrapped Ether'), _WETH[69] = /*#__PURE__*/new ERCToken(69, '0x4200000000000000000000000000000000000006', 18, 'WETH', 'Wrapped Ether'), _WETH[42161] = /*#__PURE__*/new ERCToken(42161, '0x82aF49447D8a07e3bd95BD0d56f35241523fBab1', 18, 'WETH', 'Wrapped Ether'), _WETH[421611] = /*#__PURE__*/new ERCToken(421611, '0xB47e6A5f8b33b3F17603C83a0535A9dcD7E32681', 18, 'WETH', 'Wrapped Ether'), _WETH);
...
var ELFChainToken = /*#__PURE__*/function (_BaseCurrency) {
  _inheritsLoose(ELFChainToken, _BaseCurrency);

  function ELFChainToken(chainId, address, decimals, symbol, name) {
    var _this;

    _this = _BaseCurrency.call(this, chainId, decimals, symbol, name) || this;
    _this.isNative = false;
    _this.isToken = false;
    _this.isELFChain = true;
    _this.address = address || symbol;
    return _this;
  }
  /**
   * Returns true if the two tokens are equivalent, i.e. have the same chainId and address.
  ...
  var _proto = ELFChainToken.prototype;
...
export { CurrencyAmount, ELFChainToken, ERCToken, Ether, Fraction, MaxUint256, NativeCurrency, Percent, Price, Rounding, TradeType, WETH9, WrappedTokenInfo, computePriceImpact, isAddress, sortedInsert, sqrt, validateAndParseAddress };
